...
export const Scene = ({ mainColor, path, ...props }) => {
  ...
  const ratioScale = Math.min(1.2, Math.max(2.5, window.innerWidth / 1920));
    ...
    <>
      ...
      <group {...props} dispose={null}>
        ...
        <OrbitControls
          ...
          autoRotateSpeed={0.5}
        />
        <primitive object={scene} scale={ratioScale * 0.6} /> {/* Adjust scale */}
        ...
        >
          <directionalLight
            position={[5, 5, 5]} // Adjust position to reduce the light's impact
